...
// 2013-10-01: Modifie by Mukesh Soni to generate Sine & Square wave
//____________________________________________________________________
// OUTPUT DETAILS
//--------------------------------------------------------------------
// Pin # 3  : Variable Duty Cycle PWM - For Sine Wave - 1kHz
// Pin # 11 : Variable Duty Cycle PWM - For Sine Wave - 1kHz
// Pin # 9  : Square Wave 3.921 kHz
//____________________________________________________________________
...
void setup()
{
  ...
  pinMode(9, OUTPUT);      // for square wave
...
void loop()
{
  ...
  MY_PHASE = 0;             // SET Phase (0-360 degree)
  
  icntNew = map( MY_PHASE, 0, 360, 0, 255); //DEFINE PHASE HERE HERE -- map(PHASE, 0,360,0,255)
  while(1) {
