...
void sendReadings(){
  ...
  // example output: [{"device_id":"\x28\x5c\x38\x02\x02\x00\x00\xbf","device_type":"thermometer_F","data":"64.5"},{"device_id":"\x28\xdc\x2f\x02\x02\x00\x00\x78","device_type":"thermometer_F","data":"65.2"}]
  ...
  while (ds.search(addr)){
    ...
    transmitString += "\"device_id\":\""; // "device_id":"
    for( i = 0; i < 8; i++) {
